  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#1e293b] font-sans scroll-smooth overflow-x-hidden">
     ...
     {/* --- Full Professional Footer --- */}
      <footer className="bg-slate-950 pt-20 pb-10 px-4 mt-20">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          
          {/* Logo */}
          <div className="text-3xl font-black text-white mb-8 tracking-tighter italic uppercase">
            GASHAW<span className="text-blue-500">.</span>
          </div>
          
          {/* Social Icons (LinkedIn, GitHub, Telegram) */}
          <div className="flex gap-6 mb-12">
            {/* LinkedIn */}
            <a href="#" target="_blank" className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-all shadow-lg group">
            ...
            {/* GitHub */}
            <a href="https://github.com/gashaw27" target="_blank" className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center hover:bg-slate-800 transition-all shadow-lg group border border-slate-800">
              <svg className="w-5 h-5 fill-white group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
            ...
            {/* Telegram */}
            <a href="https://t.me/@gaga2327" target="_blank" className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center hover:bg-sky-500 transition-all shadow-lg group">
              <svg className="w-5 h-5 fill-white group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
          ...
          <p className="mt-10 text-slate-800 text-[8px] font-bold tracking-widest uppercase">© 2024 DESIGNED BY GASHAW • ALL RIGHTS RESERVED</p>
        </div>
      </footer>
    </div>
  )
