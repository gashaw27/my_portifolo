      ...
      <footer className="bg-slate-950 pt-24 pb-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col items-center">
          ...
          <div className="flex gap-6 mb-12">
            ...
            {/* GitHub */}
            <a href="#" className="w-14 h-14 bg-slate-900 rounded-2xl flex items-center justify-center hover:bg-slate-800 hover:-translate-y-2 transition-all duration-300 shadow-xl group border border-slate-800">
              <svg className="w-6 h-6 fill-white group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
            ...
            {/* Telegram */}
            <a href="#" className="w-14 h-14 bg-slate-900 rounded-2xl flex items-center justify-center hover:bg-sky-500 hover:-translate-y-2 transition-all duration-300 shadow-xl group">
              <svg className="w-6 h-6 fill-white group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
