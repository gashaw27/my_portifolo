    ...
    <div className="min-h-screen bg-[#f8fafc] text-[#1e293b] font-sans scroll-smooth overflow-x-hidden">
      ...
      <footer className="bg-slate-950 pt-20 pb-10 px-4">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          <div className="text-3xl font-black text-white mb-8 tracking-tighter italic">GASHAW<span className="text-blue-500">.</span></div>
          
          {/* Social Icons */}
          <div className="flex gap-5 mb-12">
            <a href="#" className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-all">
            ...
            <a href="#" className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center hover:bg-slate-800 transition-all">
          ...
          <div className="w-full flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-slate-500 font-bold text-[10px] uppercase tracking-widest">{t.footer}</p>
            <div className="flex gap-6 text-slate-600 text-[9px] font-black uppercase tracking-widest">
              <a href="#about" className="hover:text-white transition-colors tracking-tighter">{t.navAbout}</a>
              <a href="#projects" className="hover:text-white transition-colors tracking-tighter">{t.navProjects}</a>
              <a href="#contact" className="hover:text-white transition-colors tracking-tighter">{t.navContact}</a>
            </div>
          </div>
          <p className="mt-10 text-slate-800 text-[8px] font-bold">© 2024 DESIGNED BY GASHAW</p>
        </div>
      </footer>
    </div>
  )
